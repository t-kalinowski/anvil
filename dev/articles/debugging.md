...
breakpoints to the code and step through it to identify bugs.
...
hyperparameters. For this, it’s important to monitor (intermediate)
values, which we will cover in the next section.
...
**during tracing** so that we can convert the function into a
